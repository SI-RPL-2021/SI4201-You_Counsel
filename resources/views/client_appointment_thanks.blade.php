...
<body>
    ...
    <div class="center" style="width:70%; height:700px;  background-color:white;">
        ...
        <h3 class="center" style="color:0788D9; margin-top:10px; color:#0BA9D0;font-family: 'Be Vietnam';">Schedule an Appointment
        </h3>
        ...
        <center>
            <div style="width:90%;">
                <p style="color:#0BA9D0; font-family: 'Be Vietnam';font-size: 50px;margin-top:-20px;">Okay James see you at the meeting later.</p>
            </div>
        </center>
