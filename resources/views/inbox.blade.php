        ...
        <div class="" style="float:right; margin-top:-200px; margin-right:20px; position:static;">
            <div style="margin-top:10px; color:#0BA9D0; border-color: #0BA9D0">
                <a href="/clientinbox2" style="text-decoration: none; color:#0BA9D0;">
                    <button type="submit" style="width:200px; height:35px; font-size:15px"
                        class="btn btn-outline-info btn-sm btn-block tblbackhome">Appoinment Request</button>
                </a>
            </div>
        </div>
        <!-- Isi Konten -->
        ...
        <table class="table table-bordered ml-auto mr-auto" style="position:static;width:95%; margin-top:20px;">
            <thead class="thead-light">
                <tr>
                    ...
                    <th scope="col" style="text-align:center; width:10%; color: #069FD7;">Action</th>
                </tr>
            </thead>
            <tbody>
                @php $no = 1; @endphp
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="{{$client->id}}/repliesdelete"><button type="button" class="btn btn-danger"
                                style="width:70px;">Delete</button></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
