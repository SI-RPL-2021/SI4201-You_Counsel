                    ...
                    <table class="table table-hover">
                        <thead style="background-color:#F2F2F2; color:#069ED7;">
                            <tr>
                                ...
                                <th scope="col" style="width:; text-align:center;">Message ID</th>
                                ...
                                <th scope="col" style="width:%; text-align:center;">Reply</th>
                                <th scope="col" style="width:%; text-align:center;">Action</th>
