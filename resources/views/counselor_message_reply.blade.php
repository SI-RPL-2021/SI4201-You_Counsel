        ...
        <div class="center" style="width:70%; height:600px;  background-color:white;">
            ...
            <center>
                <div align="left" style="width:60%;">
                    <form style="font-size:18px; color:#0BA9D0;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 ml-5">
                                <input type="text" class="form-control" id="inputStudentID" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="message_reply" rows="4" placeholder="Write down your thoughts...."></textarea>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10">
