            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form id="contact-form" class="form" action="/postlogin" method="POST" role="form">
                <?php echo e(csrf_field()); ?>
                        ...
                        <p style="color: white; text-align:center;">Don't have an Account? <a style="color:white" href="/register"><b>Register</b></a></p>
                      </form>
            </div>
          </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\SI4201-You_Counsel\resources\views/login1.blade.php ENDPATH**/ ?>