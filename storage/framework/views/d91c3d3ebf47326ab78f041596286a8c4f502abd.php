...
<body>
  ...
  <div class="center" style="width:70%; height:700px;  background-color:white;">
    ...
    <table class="table table-bordered ml-auto mr-auto" style="position:static;width:95%; margin-top:20px;">
      ...
      <tbody>
      <?php $__currentLoopData = $clientjournal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          <th scope="row" style="text-align:center;"> <?php for ($i=1; $i <= 10; $i++) {echo " ".$i ;} ?> </th>
          <td><?php echo e($client->created_at); ?></td>
          <td><?php echo e($client->mood); ?></td>
...
</html><?php /**PATH C:\xampp\htdocs\SI4201-You_Counsel\resources\views/client_journalhistory.blade.php ENDPATH**/ ?>