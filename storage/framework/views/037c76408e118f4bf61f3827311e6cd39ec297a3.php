...
<body>
  ...
  <div class="center" style="width:70%; height:700px;  background-color:white;">
    ...
    <form action="/postjournal" method="POST">
      ...
      <center>
        <div style="width:90%;">
          <p style="color:#0BA9D0; font-family: 'Be Vietnam';font-size: 50px;margin-top:-20px;">Sorry to hear that, do
            you mind to tell us about today?</p>
        </div>
      </center>
...
</html><?php /**PATH C:\xampp\htdocs\SI4201-You_Counsel\resources\views/client_myjournal_sad.blade.php ENDPATH**/ ?>