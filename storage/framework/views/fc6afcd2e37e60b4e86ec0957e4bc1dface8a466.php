  ...
  <div class="center" style="width:70%; height:700px;  background-color:white;">
    ...
    <form action="/postjournal" method="POST">
      ...
      <div class="form-group">
        <input type="hidden" class="form-control" id="mood" name="mood" value="Flat">
      </div>

      <p style="font-size:100px;text-align:center;margin-top:-40px;margin-right:75px">&#128528;</p>
      <center>
        <div style="width:90%;">
          <p style="color:#0BA9D0; font-family: 'Be Vietnam';font-size: 50px;margin-top:-20px;">Do you mind to tell us
            about today?</p>
        </div>
      </center>
...
</html><?php /**PATH C:\xampp\htdocs\SI4201-You_Counsel\resources\views/client_myjournal_flat.blade.php ENDPATH**/ ?>